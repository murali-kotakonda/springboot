...
import rest.basics.provider.exception.ServiceException;
...
public class EmpController {
	...
	public List<String> getListStr() {
		return Lists.newArrayList("hi","hello");
	}
	
	@RequestMapping("/emp")
	public Employee getEmp() {
		Employee e = new Employee(1000, "user1", 122);
		return e;
	}
...
*/
	...
	public ResponseEntity<EmpResponse> getEmpById(
	...
	/*
	How do you send request data to the server?
	- Request param
	- Request body
	- path Param
	 
	 Request param:
	 http://<baseurl>/v1/dataWithPathParam/1224/kumar
	 */
	@GetMapping(value="/dataWithAllParams/{id}/{name}", produces = {MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE})
	public String dataWithAllParams(
			@PathVariable(value  = "id", required = true) String id,
			@PathVariable(value = "name", required = true) String name,
			@RequestParam(value = "city", required = false) String city,
			@RequestParam(value = "sal", required = false) String sal) {
		return "your data  id = " + id +" - " + name + " city = "+city +" - sal "+sal;
	}
	...
	public ResponseEntity<Object> empDelete(@PathVariable("id") String id) {
		if(id.contains("P_")) {
